using ChoresAPI.JSON;
using ChoresAPI.Shared;
...
namespace ChoresAPI.Authentication
{
    public class ApiKeyAuthenticationHandler : AuthenticationHandler<ApiKeyAuthenticationOptions>
    {
        ...
        private readonly IGetAllApiKeys _getApiKeyQuery;
        ...
        public ApiKeyAuthenticationHandler(
            ...
            UrlEncoder encoder,
            ISystemClock clock,
            IGetAllApiKeys getApiKeyQuery) : base(options, logger, encoder, clock)
        {
